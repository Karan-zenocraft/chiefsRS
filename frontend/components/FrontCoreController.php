    ...
    public function behaviors() {
        ...
        $amAccessRules = array(
            'access' => [
                ...
                'rules' => [
                    [
                        'actions' => ['login','index','error','request-password-reset','signup','reset-password','restaurants','restaurant-details',/* 'forgotPassword',*/ 'gii' /*,'get-milestones' ,'get-tasks','update-milestone-status','update-task-status','get-tasks-hours'*/],
                        'allow' => true,
                    ],
                ],
            ],
