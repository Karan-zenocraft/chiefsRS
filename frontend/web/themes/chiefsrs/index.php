...
<!--     
  ...
  <body data-spy="scroll" data-target="#site-navbar" data-offset="200" class="example-1  scrollbar-dusty-grass square thin">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="site-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a href="#section-gallery" class="nav-link">Logout</a></li>
          </ul>
        </div>
      </div>
    </nav>
    ...
    <section class="site-cover" style="background-image: url(images/bg_3.jpg);" id="section-home">
      <div class="container">
        <div class="row align-items-center site-vh-100">
          <div class="col-md-9">
            <?php 
        $url = "http://localhost/eatwell/images/chiefs-rs-text.png";
        ?>
        <a class="navbar-brand" href="#"><img src="<?php echo $url; ?>" width="70%" height="70%"></a>
          ...
          <!--   <a href="https://colorlib.com/" target="_blank" class="btn btn-outline-white btn-lg site-animate" data-toggle="modal" data-target="#reservationModal">Reservation</a> -->
            <p><input type="text" name="search_restaurant" class="search_text site-animate" placeholder="Search for a Restaurant"><a href="https://colorlib.com/" target="_blank" class="btn btn-outline-white btn-lg site-animate" data-toggle="modal" data-target="#reservationModal"><i class="fas fa-search"  style="font-size:30px;text-align:center;"></i> </a></p>
          </div>
    ...
    <div class="logo">
    <center><img src="images/Chiefs_rs_logo.png" alt=""></center>
  </div>
