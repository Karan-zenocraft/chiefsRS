...
<?php } ?>
  ...
  <center><div id="loading" style="display:none;position:center;padding:2px;"><img src="<?php echo ($_SERVER['HTTP_HOST'] == "localhost") ? Yii::getAlias('@web').'../../../common/web/img/loading.gif' : '/common/web/img/loading.gif'; ?>" width="64" height="64" /><br>Loading..</div></center>
