...
*/
    ...
    */
    public static function full_day_type_leave_request( $model ) {
        ...
        $snUserName = $snRequesterEmail->first_name.' '.$snRequesterEmail->last_name;
    ...
    */
    ...
    /*  public static function get_team_leaders_name($flag=false) {
        if ( $flag ) {
            ...
            $arrTeamLeads = ArrayHelper::map( Users::find()->where( "role_id = '".Yii::$app->params['userroles']['admin']."' AND id != '".Yii::$app->user->id."' AND company = 'INHERITX' AND status = '1'" )->orderBy( 'first_name' )->asArray()->all(), 'id', function( $user ) {
                    return $user['first_name'].' '.$user['last_name'];
                } );
        }else {
            $arrTeamLeads = ArrayHelper::map( Users::find()->where( "(role_id = '".Yii::$app->params['userroles']['admin']."' OR role_id = '".Yii::$app->params['userroles']['hr_admin']."' OR role_id = '".Yii::$app->params['userroles']['sales_admin']."') AND id != '".Yii::$app->user->id."' AND company = 'INHERITX' AND status = '1'" )->orderBy( 'first_name' )->asArray()->all(), 'id', function( $user ) {
                    return $user['first_name'].' '.$user['last_name'];
                } );
        }
        return $arrTeamLeads;
    ...
    /*  public static function get_team_leaders() {
        $arrTeamLeads = ArrayHelper::map( Users::find()->where( "role_id = '".Yii::$app->params['userroles']['admin']."' AND company = 'INHERITX' AND status = '1'" )->orderBy( 'first_name' )->asArray()->all(), 'id', function( $user ) {
                return $user['first_name'].' '.$user['last_name'];
            } );
    ...
    public static function get_users_by_role_id( $first_role_id = '', $second_role_id = '', $third_role_id = '' ) {
        if ( $second_role_id == '' && $third_role_id == '' ) {
            $arrUsers = ArrayHelper::map( Users::find()->where( "role_id = '".$first_role_id."' AND company = 'INHERITX' AND status = '1'" )->orderBy( 'first_name' )->asArray()->all(), 'id', function( $user ) {
                    return $user['first_name'].' '.$user['last_name'];
                } );
        }else if ( $third_role_id == '' ) {
                $arrUsers = ArrayHelper::map( Users::find()->where( "(role_id = '".$first_role_id."' OR role_id = '".$second_role_id."') AND company = 'INHERITX' AND status = '1'" )->orderBy( 'first_name' )->asArray()->all(), 'id', function( $user ) {
                        return $user['first_name'].' '.$user['last_name'];
                    } );
            }else {
            $arrUsers = ArrayHelper::map( Users::find()->where( "(role_id = '".$first_role_id."' OR role_id = '".$second_role_id."' OR role_id = '".$third_role_id."') AND id != '".Yii::$app->user->id."' AND company = 'INHERITX' AND status = '1'" )->orderBy( 'first_name' )->asArray()->all(), 'id', function( $user ) {
                    return $user['first_name'].' '.$user['last_name'];
                } );
        }
        return $arrUsers;
