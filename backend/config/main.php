    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'manage-restaurants-floors/<rid>' => 'restaurant-floors/index',
                ...
                'manage-floors-tables/<rid>/<lid>' => 'restaurant-tables/index',
                'create-floors-tables/<rid>/<lid>' => 'restaurant-tables/create',
                'update-floors-tables/<id>/<rid>/<lid>' => 'restaurant-tables/update',
                'delete-floors-tables/<id>/<rid>/<lid>' => 'restaurant-tables/delete',
                'manage-user-reservations/<user_id>' => 'reservations/index',
                'update-reservation/<id>/<user_id>' => 'reservations/update',
                'create-reservation/<user_id>' => 'reservations/create',
                'create-reservation/<user_id>' => 'reservations/create',
                'manage-restaurant-reservations/<restaurant_id>' => 'reservations/index',
